# 📋 개별 작업 지침서: 저장소 보드뷰 새 기보 작성 버튼과 입력 뷰 전환 (TASK-035)
...
- **현재 상태 요약**: 저장소 기본 화면은 보드뷰로 고정되었지만, 거기서 기보 입력 화면으로 넘어가는 명시적 진입 동작이 없습니다.
- **이 작업의 책임**: 저장소 기본 보드뷰의 새 기보 작성 버튼과 기보 입력 뷰 전환 규칙을 구현합니다.
...
- **최종 상태**: 사용자가 저장소 기본 보드뷰에서 새 기보 작성 버튼을 눌러 기보 입력 화면으로 이동합니다.
- **이번 작업의 최소 결과물**:
...
- **핵심 구현 대상**:
  ...
  - repository home page는 CTA를 배치하고 진입 이유를 설명하는 카피를 둘 수 있습니다.
- **데이터 모델 해석**:
...
- [ ] 저장소 기본 보드뷰에서 새 기보 작성 CTA가 보인다.
- [ ] 버튼이 기보 입력 화면으로 이동시킨다.
- [ ] 초안 확인 규칙과 연결할 수 있다.

## 💬 9. 추천 커밋 메시지

- `feat: 저장소 보드뷰에서 새 기보 작성 진입을 추가`
