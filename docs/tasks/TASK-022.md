...
- **최종 상태**: 사용자가 반수, 코멘트, 어노테이션, 메타데이터를 수정하면 초안이 자동으로 브라우저 저장소에 반영됩니다.
- **이번 작업의 최소 결과물**:
...
- **성공 기준 (AC)**:
  ...
  - 초안 직렬화 대상에는 보드 상태, 수순 목록, 코멘트, 어노테이션, 메타데이터가 포함된다.
